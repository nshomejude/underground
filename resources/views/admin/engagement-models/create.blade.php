<x-admin.shell title="New Engagement Model">
    <form method="POST" action="{{ route('admin.engagement-models.store') }}" class="flex flex-col gap-6 border border-border bg-surface px-6 py-8 sm:px-10 sm:py-10">
        @csrf

        <x-admin.field name="name" label="Name" />
        <x-admin.field name="slug" label="Slug" placeholder="retained-advisory" />
        ...
        <div class="flex items-center gap-4 pt-2">
            <x-button variant="primary" type="submit">Create Engagement Model</x-button>
